...
class ImageHelper {
    ...
    public static function imageToBytes($img, $imgExt = 'jpeg') {
    ...
    public static function cropImage_1($x, $y, $w, $h, $targetImage) {
        return imagecrop($targetImage, [
            'x' => $x,
            'y' => $y,
            'width' => $w,
            'height' => $h
        ]);
        $canvas = imagecreatetruecolor(imagesx($targetImage), imagesy($targetImage));
...
//                $w, $h
    ...
    public static function cropAndResizeImage_1($x, $y, $w, $h, $targetImage, $resizeW, $resizeH) {
        $resizedImage =  self::resizeImage($resizeW, $resizeH, $targetImage);

        $resizedImage = imagecreatefromstring( self::imageToBytes($resizedImage, 'jpeg') );
        $croppedImage = self::cropImage_1($x, $y, $resizeW, $resizeH, $resizedImage, 'jpeg');
    ...
    public static function scaleAndCrop1($x, $y, $w, $h, $targetImage, $resizeW, $resizeH) {
        $resizedImage =  self::scaleImage($targetImage, $resizeW, $resizeH);
